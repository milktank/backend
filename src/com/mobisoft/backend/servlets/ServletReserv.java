 ...
 */
@WebServlet("/reserv")
public class ServletReserv extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Empresas e = new Empresas("Empresa dos Chines", "0987654321", "Epit�cio Pessoa");
		new EmpresaDAO().insert(e);
		
		Restaurante r = new Restaurante("China InBox2", "In Box2 Epit�cio", 1.4d, 1.5d, "http://www.myigadget.com/blog-en/blog/wp-content/uploads/2011/04/93aadd95iphone3g-4.jpg", e, cr);
