...
import com.empresa.backend.entities.CategoriaEmpresa;
import com.empresa.backend.entities.CategoriaRestaurante;
import com.empresa.backend.entities.CredencialPagSeguro;
...
import com.empresa.backend.entities.RedesSociais;
...
public class ManagerDAO {
	...
	public ManagerDAO(){
	    ...
	    String conn = "jdbc:postgresql://localhost:5432/mobway";  
	    String user = "renato";  
	    String senha = "santoo";
	     ...
	     * mapeamento 
	     */    
	    configuration.addAnnotatedClass(RedesSociais.class);
	    configuration.addAnnotatedClass(CredencialPagSeguro.class);
	    configuration.addAnnotatedClass(CategoriaEmpresa.class);
	    ...
	    configuration.addAnnotatedClass(MensagemBroadcast.class);
	    configuration.addAnnotatedClass(Doacao.class);
	    configuration.addAnnotatedClass(UrlsImages.class);
	      
	    ManagerDAO.factory = configuration.buildSessionFactory();
	    System.out.println("Final de configuracao");
	}
}
